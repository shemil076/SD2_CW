...
public class VaccinationCenter {
    ...
    public static LinkedList<Patient> linkedListPfizer = new LinkedList<Patient>();
...
//         patientAstraZeneca.setPatientLastName("sam");
//         patientAstraZeneca.setPatientCity("kandy");
//
//         linkedListAstraZeneca.add(patientAstraZeneca);
//
//        patientAstraZeneca2.setPatientFirstName("supper");
//        patientAstraZeneca2.setPatientLastName("mike");
//        patientAstraZeneca2.setPatientCity("colombo");
//
//        linkedListAstraZeneca.add(patientAstraZeneca2);
//
//
//        patientSinopharm.setPatientFirstName("kalum");
//        patientSinopharm.setPatientLastName("john");
//        patientSinopharm.setPatientCity("colombo");
//
//        linkedListSinopharm.add(patientSinopharm);
//
//        patientSinopharm.setPatientFirstName("brayn");
//        patientSinopharm.setPatientLastName("joe");
//        patientSinopharm.setPatientCity("colombo");
//
//        linkedListSinopharm.add(patientSinopharm);
//
//
//        patientPfizer.setPatientFirstName("bob");
//        patientPfizer.setPatientLastName("sponge");
//        patientPfizer.setPatientCity("colombo");
//
//        linkedListPfizer.add(patientPfizer);
//
//        patientPfizer.setPatientFirstName("bat");
//        patientPfizer.setPatientLastName("man");
//        patientPfizer.setPatientCity("colombo");
//
//        linkedListPfizer.add(patientPfizer);
        ...
        initialise(patients);
//        initialisepatientsNamesAstraZeneca(patientsNamesAstraZeneca);
...
//    public static void initialisepatientsNamesAstraZeneca(Patient[] patientsNamesAstraZeneca) {
//        for (int i = 0; i < patientsNamesAstraZeneca.length; i++) {
//            patientsNamesAstraZeneca[i] = new Patient( "~","~",0,"~",0,"~");
//        }
//    }
    /**
            ...
            while (true) {
                ...
                if (input.hasNextInt()) {
                    ...
                    if (find) {
                        if (boothNo == 6) {
                        ...
                        } else  if ((boothNo == 0) || (boothNo == 1)){
                            if (linkedListAstraZeneca.isEmpty()) {
                            ...
                            }else if ((boothNo == 2) || (boothNo == 3)){
                                if(linkedListSinopharm.isEmpty()){
                                    ...
                                    patients[boothNo].setPatientFirstName(linkedListSinopharm.getFirst().getPatientFirstName());
                                    patients[boothNo].setPatientLastName(linkedListSinopharm.getFirst().getPatientLastName());
                                ...
                                if (linkedListSinopharm.isEmpty()){
                                    ...
                                    patients[boothNo].setPatientFirstName(linkedListPfizer.getFirst().getPatientFirstName());
                                    patients[boothNo].setPatientLastName(linkedListPfizer.getFirst().getPatientLastName());
                                    patients[boothNo].setPatientAge(linkedListPfizer.getLast().getPatientAge());
                                    patients[boothNo].setPatientCity(linkedListPfizer.getLast().getPatientCity());
...
//
    ...
    public static void showLists(){
        ...
        System.out.println("");
        System.out.println("Pfizer" + linkedListPfizer);
    }
}
